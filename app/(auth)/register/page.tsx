        ...
        <div className="max-w-md mx-auto px-4 sm:px-6 lg:px-8">
          <Card className="p-8">
            <div className="text-center mb-8">
              <h1 className="font-serif text-3xl text-text-dark mb-2 tracking-heading leading-heading">Join Noor</h1>
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div>
                ...
                <div className="grid grid-cols-2 gap-4">
                  <button
                    ...
                    className={`p-4 border rounded-md text-center transition-fluid duration-300 ${formData.accountType === 'buyer' ? 'border-gold bg-gold/10' : 'border-border hover:border-gold/50'}`}
                  >
                  ...
                  <button
                    ...
                    className={`p-4 border rounded-md text-center transition-fluid duration-300 ${formData.accountType === 'seller' ? 'border-gold bg-gold/10' : 'border-border hover:border-gold/50'}`}
                  >
              ...
              <div className="text-center mt-6">
                <p className="text-text-muted font-sans">
                  ...
                  <Link href="/login" className="text-gold hover:underline font-medium transition-fluid duration-300">
                    Sign in
                  </Link>
                </p>
              </div>
